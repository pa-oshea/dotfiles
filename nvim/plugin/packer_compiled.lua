...
_G.packer_plugins = {
  ["Comment.nvim"] = {
    after_files = { "/home/patrick/.local/share/nvim/site/pack/packer/opt/Comment.nvim/after/plugin/Comment.lua" },
    config = { "\27LJ\2\nF\0\0\3\0\3\0\0066\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\1K\0\1\0\fcomment\27plugins.configs.others\frequire\0" },
    keys = { { "", "gc" }, { "", "gb" } },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
    path = "/home/patrick/.local/share/nvim/site/pack/packer/opt/Comment.nvim",
  ...
  base46 = {
    ...
    loaded = true,
    path = "/home/patrick/.local/share/nvim/site/pack/packer/start/base46",
    url = "https://github.com/NvChad/base46"
  },
  ["cmp-buffer"] = {
    after = { "cmp-path" },
    after_files = { "/home/patrick/.local/share/nvim/site/pack/packer/opt/cmp-buffer/after/plugin/cmp_buffer.lua" },
    load_after = {
      ["cmp-nvim-lsp"] = true
    },
    loaded = false,
    needs_bufread = false,
    path = "/home/patrick/.local/share/nvim/site/pack/packer/opt/cmp-buffer",
    url = "https://github.com/hrsh7th/cmp-buffer"
  },
  ["cmp-nvim-lsp"] = {
    after = { "cmp-buffer" },
    after_files = { "/home/patrick/.local/share/nvim/site/pack/packer/opt/cmp-nvim-lsp/after/plugin/cmp_nvim_lsp.lua" },
    load_after = {
      ["cmp-nvim-lua"] = true
    },
    loaded = false,
    needs_bufread = false,
    path = "/home/patrick/.local/share/nvim/site/pack/packer/opt/cmp-nvim-lsp",
    url = "https://github.com/hrsh7th/cmp-nvim-lsp"
  },
  ["cmp-nvim-lua"] = {
    after = { "cmp-nvim-lsp" },
    after_files = { "/home/patrick/.local/share/nvim/site/pack/packer/opt/cmp-nvim-lua/after/plugin/cmp_nvim_lua.lua" },
    load_after = {
      cmp_luasnip = true
    },
    loaded = false,
    needs_bufread = false,
    path = "/home/patrick/.local/share/nvim/site/pack/packer/opt/cmp-nvim-lua",
    url = "https://github.com/hrsh7th/cmp-nvim-lua"
  },
  ["cmp-path"] = {
    after_files = { "/home/patrick/.local/share/nvim/site/pack/packer/opt/cmp-path/after/plugin/cmp_path.lua" },
    load_after = {
      ["cmp-buffer"] = true
    },
    loaded = false,
    needs_bufread = false,
    path = "/home/patrick/.local/share/nvim/site/pack/packer/opt/cmp-path",
  ...
  extensions = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/patrick/.local/share/nvim/site/pack/packer/opt/extensions",
  ...
  ["friendly-snippets"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/patrick/.local/share/nvim/site/pack/packer/opt/friendly-snippets",
  ...
  ["gitsigns.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/patrick/.local/share/nvim/site/pack/packer/opt/gitsigns.nvim",
  ...
  ["indent-blankline.nvim"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/patrick/.local/share/nvim/site/pack/packer/opt/indent-blankline.nvim",
  ...
  ["nvim-autopairs"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/patrick/.local/share/nvim/site/pack/packer/opt/nvim-autopairs",
  ...
  ["nvim-cmp"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/patrick/.local/share/nvim/site/pack/packer/opt/nvim-cmp",
  ...
  ["nvim-colorizer.lua"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/patrick/.local/share/nvim/site/pack/packer/opt/nvim-colorizer.lua",
  ...
  ["nvim-lsp-installer"] = {
    ...
    needs_bufread = true,
    only_cond = false,
    path = "/home/patrick/.local/share/nvim/site/pack/packer/opt/nvim-lsp-installer",
  ...
  ["nvim-lspconfig"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/patrick/.local/share/nvim/site/pack/packer/opt/nvim-lspconfig",
  ...
  ["nvim-tree.lua"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/patrick/.local/share/nvim/site/pack/packer/opt/nvim-tree.lua",
  ...
  nvterm = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/patrick/.local/share/nvim/site/pack/packer/opt/nvterm",
  ...
  ["plenary.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/patrick/.local/share/nvim/site/pack/packer/opt/plenary.nvim",
  ...
  ["which-key.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/patrick/.local/share/nvim/site/pack/packer/opt/which-key.nvim",
